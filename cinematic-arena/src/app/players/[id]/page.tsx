      ...
      <div className="mx-auto max-w-[1200px] px-6 pb-24">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="holo-panel clip-corner p-6">
            ...
            <div className="space-y-3">
              {[
                { event: "BGMI Championship Series", position: "1ST", prize: "₹2,10,000" },
                { event: "BGMI Pro League S2", position: "3RD", prize: "₹1,25,000" },
                { event: "BGMI Community Clash", position: "1ST", prize: "₹75,000" },
              ].map((t, i) => (
                <div key={i} className="flex items-center justify-between border border-[#1a2134] bg-[#0a0d16]/60 px-4 py-3">
                  <div>
